...
int GLViewNewModule::getOffset() {
    return offset;
}

void GLViewNewModule::setOffset(int newOffset) {
    offset = newOffset;
}


void GLViewNewModule::spawnItem(bool toSend) {
...
void GLViewNewModule::movePlayer(Vector translate, Vector rotate, bool toSend) {
    player->moveRelative(translate);
    player->rotateAboutGlobalZ(rotate.z);
